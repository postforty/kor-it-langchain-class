...
- `Store`를 이용해 사용자의 특징과 취향을 영원히 기억하기
- 대화할 때 자연스럽게 옛날 기억을 떠올리는 방법 배우기 (Memory Injection)

---

### 11일차: 가드레일로 안전한 RAG 챗봇 만들기! (4시간)

#### Section 11-01

- 오픈소스 LLM 가드레일 프레임워크 알아보기 (NeMo Guardrails, Guardrails AI, LlamaIndex, LangChain Content Safety)
- Kanana Safeguard 모델을 활용한 입력/출력 안전성 검사 래퍼 함수 만들기
- LangChain 체인에 입력·출력 가드레일 통합하기 (RunnableBranch)

#### Section 11-02

- zerox를 활용해 PDF 문서(소득세법)를 마크다운으로 변환하고 전처리하기
- LangGraph로 RAG 기반 소득세법 질의응답 에이전트 만들기 (State, Node, Edge)
- Gradio를 활용해 대화형 법률 상담 챗봇 서비스 구축하기 (PGVector, Ollama)
